...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:app\\.watarrow\\.com)$)$", port: "", pathname: "^(?:\\/assets(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
...
// node_modules/.pnpm/@opennextjs+cloudflare@1.20.1_next@15.5.20_@babel+core@7.29.7_babel-plugin-react-compil_04e7f815566871e185cc2f9a540c14fc/node_modules/@opennextjs/cloudflare/dist/cli/templates/images.js
